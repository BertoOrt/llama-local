...
app.factory('AuthUser', ['$http', '$location', 'ipCookie', '$q', function ($http, $location, ipCookie, $q) {
  ...
  authuser.signup = function (data) {
    ...
    $http.post('https://arcane-castle-8723.herokuapp.com/signup', data).success(function (response, stat) {
  ...
  authuser.login = function (data) {
    var promise = $q.defer();
    $http.post('https://arcane-castle-8723.herokuapp.com/login', data).success(function (response, stat) {
  ...
  authuser.authenticate = function () {
    ...
    $http.post('https://arcane-castle-8723.herokuapp.com/user/auth', data).success(function (response, stat) {
      if (response.status == "ok") {
        return promise.resolve(true);
      } else {
        return false;
...
app.controller('home', ['$scope', '$http', '$location', 'AuthUser', 'ipCookie', function ($scope, $http, $location, AuthUser, ipCookie) {
  ...
  $scope.sendMail = function () {
    ...
    $http.post('https://arcane-castle-8723.herokuapp.com/mail', data).success(function (response) {
...
app.controller('search', ['$scope', 'AuthUser', '$http', '$location', function ($scope, AuthUser, $http, $location) {
  ...
  $http.get('https://arcane-castle-8723.herokuapp.com/users').success(function (response) {
    console.log(response);
...
app.controller('user', ['$scope', '$http', 'ipCookie', '$location', 'AuthUser', function ($scope, $http, ipCookie, $location, AuthUser) {
  ...
  $http.post('https://arcane-castle-8723.herokuapp.com/user/info', { id: $scope.user.id, url: $scope.url }).success(function (response, stat) {
    if (response.status == "ok") {
  ...
  $scope.submitBioForm = function () {
    ...
    $http.post('https://arcane-castle-8723.herokuapp.com/user/editInfo', $scope.user).success(function (response, stat) {
  ...
  $scope.submitPackageForm = function () {
    ...
    $http.post('https://arcane-castle-8723.herokuapp.com/user/package', { id: ipCookie('user'), 'package': $scope['package'] }).success(function (response, stat) {
      $scope.sendingInfo = false;
      if (response.status == "ok") {
        $scope['package'] = "";
  ...
  $scope.changeUrl = function () {
    ...
    $http.post('https://arcane-castle-8723.herokuapp.com/user/url', data).success(function (response) {
      if (response.status == "ok") {
  ...
  $scope.editPackage = function () {
    $http.post('https://arcane-castle-8723.herokuapp.com/user/editPackage', { id: ipCookie('user'), 'package': this['package'] }).success(function (response, stat) {
      $scope.sendingInfo = false;
      if (response.status == "ok") {
        $('.packageTab').click();
        $('.packageMessage').fadeIn();
  ...
  $scope.removePackage = function (i) {
    ...
    $http.post('https://arcane-castle-8723.herokuapp.com/user/removePackage', { id: ipCookie('user'), 'package': this['package'] }).success(function (response, stat) {
      $scope.sendingInfo = false;
      if (response.status == "ok") {
        console.log('deleted');
      } else {
  ...
  $scope.submitReview = function () {
    ...
    $http.post('https://arcane-castle-8723.herokuapp.com/user/addReview', { id: ipCookie('user'), reference: $location.path().substring(1), badge: $scope.isChecked, review: $scope.reviewText }).success(function (response) {
      $scope.isChecked = '';
      $scope.reviewText = '';
    }).error(function (data) {
      $location.path('/error');
  ...
  $scope.share = function () {
    ...
    $http.post('https://arcane-castle-8723.herokuapp.com/user/share', { id: $scope.user.facebookId, token: $scope.user.facebookToken, url: $location.path().substring(1) }).success(function (response) {
      console.log(response);
      if (response.status == "ok") {
